...
1. Install via [NPM](https://www.npmjs.com/package/vanilla-cookieconsent).
    ...
    ```sh [npm]
    npm i vanilla-cookieconsent@3.0.1-patch.1
    ```

    ```sh [pnpm]
    pnpm add vanilla-cookieconsent@3.0.1-patch.1
    ```

    ```sh [yarn]
    yarn add vanilla-cookieconsent@3.0.1-patch.1
    ```
...
2. Use the CDN hosted version.
    ...
    stylesheet:
    ```
    https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.0.1-patch.1/dist/cookieconsent.css
    ```

    script:
    ```
    https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.0.1-patch.1/dist/cookieconsent.umd.js
    ```
...
<html>
    <head>
        <!-- head content -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.0.1-patch.1/dist/cookieconsent.css">
    </head>
    <body>
        <!-- body content -->
...
```javascript{1}
import 'https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.0.1-patch.1/dist/cookieconsent.umd.js';
